...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'commando_super_secret_123')

# --- CONFIGURACIÓN DE BASE DE DATOS (ESTABILIDAD TOTAL) ---
# Si estamos en Render, usará DATABASE_URL. Si estamos en PC, usará SQLite.
...
def register():
    if request.method == 'POST':
        ...
        if user_exists:
            ...
            new_user = User(username=request.form['username'].strip(), password=hashed_pw)
